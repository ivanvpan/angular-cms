...
* redactor-resizable-plugin-0.2.tgz_
* redactor-resizable-plugin-0.1.tgz_ 

See the Changelog_ for more infos about the releases.

.. _redactor-resizable-plugin-0.2.tgz: http://pyjax.net/download/wymeditor-resizable-plugin-0.2.tgz
.. _redactor-resizable-plugin-0.1.tgz: http://pyjax.net/download/wymeditor-resizable-plugin-0.1.tgz
...
it's done::
    ...
    // Get the jQuery UI resizeable plugin and then init the redactor resizable
...
.. _WYMeditor:              http://www.redactor.org/
.. _WYMeditor plugin page:  http://trac.redactor.org/trac/wiki/0.4/Plugins
