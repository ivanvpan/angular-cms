...
// Default settings
    var DEFAULT_SETTINGS = {
        ...
        theme: null,
        zindex: 999,
        resultsFormatter: function(item){ console.log(this.propertyToSearch);return "<li>" + item[this.propertyToSearch]+ "</li>" },
        tokenFormatter: function(item) { console.log('property to search', this.propertyToSearch); return "<li><p>" + item[this.propertyToSearch] + "</p></li>" },
